...
-> necessary data for mariginal lag 0: `weather temperature/Berlin_lag0_setup.RData`) and saves *L_2 normed* multiplier bootstrap samples and eigenvalues as `month.mb.rds`  <br>
-> necessary data for long-run kernel (`weather temperature/Berlin_lagb_setup.RData`) and saves *L_2 normed* multiplier bootstrap samples and eigenvalues as `month.mb.LR.rds` <br>
